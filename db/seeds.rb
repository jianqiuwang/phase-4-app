...
# Create some reviews
review1 = Review.create(username: "john_doe", score: 9, comment: "This movie was amazing!", likes: 3, movie: movie1, user: user1)
review2 = Review.create(username: "jane_smith", score: 8, comment: "Great movie, but a bit long.", likes: 2, movie: movie2, user: user2)
review3 = Review.create(username: "john_doe", score: 10, comment: "The best superhero movie ever!", likes: 5, movie: movie3, user: user1)
review4 = Review.create(username: "mike_jones", score: 10, comment: "Absolutely mind-blowing!", likes: 4, movie: movie4, user: user3)
review5 = Review.create(username: "sarah_walker", score: 9, comment: "Heartwarming and inspiring!", likes: 3, movie: movie5, user: user4)
review6 = Review.create(username: "mike_jones", score: 8, comment: "A groundbreaking sci-fi masterpiece.", likes: 2, movie: movie6, user: user3)
review7 = Review.create(username: "john_doe", score: 7, comment: "Entertaining, but not as good as the first two Godfather movies.", likes: 1, movie: movie2, user: user1)
